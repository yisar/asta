...
import { watch as effect, unwatch, reactive, isReactive } from './reactive'
import { ref, toRefs, isRef } from './ref'
...
function setup(factory) {
  let vdom = React.memo(props => {
    ...
    const w = React.useRef() as any
    const r = React.useRef() as any
